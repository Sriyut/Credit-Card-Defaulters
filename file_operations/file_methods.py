...
class File_Operation:
    ...
    def load_model(self,  filename):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occurred in load_model method of the Model_Finder class. Exception message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
    ...
    def find_correct_model_file(self,  cluster_number):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occurred in find_correct_model_file method of the Model_Finder class. Exception message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
